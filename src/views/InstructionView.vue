    ...
    <div class="slides-container" :style="{ transform: `translateY(-${currentSection * 100}vh)` }">
      ...
      <div class="slide-section">
        <div class="content-card">
          ...
          <div class="instruction-image">
            <img :src="API_URL + '/media/instruction/movieselect1.gif'" alt="영화 검색 방법" />
          </div>
      ...
      <div class="slide-section">
        <div class="content-card">
          ...
          <h3 class="gradient-text">1. 영화 선택</h3>
          <div class="instruction-image">
            <img :src="API_URL + '/media/instruction/movieselect2.gif'" alt="영화 검색 방법" />
          </div>
      ...
      <div class="slide-section">
        <div class="content-card">
          ...
          <div class="instruction-image">
            <img :src="API_URL + '/media/instruction/promptinput.gif'" alt="프롬프트 작성 방법" />
          </div>
      ...
      <div class="slide-section">
        <div class="content-card">
          ...
          <h3 class="gradient-text">2. 프롬프트 작성</h3>
          <div class="instruction-image">
            <img :src="API_URL + '/media/instruction/promptreinput.gif'" alt="프롬프트 작성 방법" />
          </div>
      ...
      <div class="slide-section">
        <div class="content-card">
          ...
          <div class="instruction-image">
            <img :src="API_URL + '/media/instruction/postending.gif'" alt="결과 확인 및 공유 방법" />
          </div>
